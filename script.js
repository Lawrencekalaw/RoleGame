...
const locations = [
    ...
    {
        name: "cave", "button text":["Fight slime", "Fight fanged beast","Go town square"], "button functions": [fightSlime, fightBeast, goTown], text: "You enter the cave. You see some monsters."
    },
    {
    ...
    {
        name: "easter egg", "button text": ["2", "8", "Go town square?"], "button functions": [pickTwo, pickEight, goTown], text: "You find a secret game. Pick a number above. Ten numbers will be randomly chosen between 0 and 10. If the number yoo choose matches one of your random numbers, you win!"
    }
];
// initialize buttons
...
function pick(guess){
    ...
    text.innerText = "You picked " + guess + ". Here are te random numbers: \n";
    for(let i = 0; i < 10; i++ ){
